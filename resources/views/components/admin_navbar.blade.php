    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                @if (!(auth()->user()->hasRole('admin') || auth()->user()->hasRole('data-entry-operator') || auth()->user()->hasRole('data-verification-operator') || auth()->user()->hasRole('web-admin')))
                    <a class="dropdown-item" href="{{ url('/view/my/profile') }}">
