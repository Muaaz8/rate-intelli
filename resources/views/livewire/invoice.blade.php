    ...
    <section class="back_sign__ py-3">
        <div class="container-fluid">
            <div class="col-md-8  m-auto">
              <h2 class="fw-bold fs-1 text-white text-center p-4">
                INTELLI-RATE
            </h2>
                <div class="main_signUp">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="mb-3 text-center">
                                <button type="submit"
                                    class="btn btn-outline-primary max_contant submit_btn" wire:click="download">Download Invoice</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3 p-3">
                        <div class="col-md-12">
                            <div class="bank_select_divv p-4" style="height: 300px">
                                <h2 class="text-center"> <u>Terms & Conditions</u></h2>
                                <p>
                                  ...
                                  <p>
                                    ...
                                    Services for the data that you purchased for a period of one year.Your subscription will automatically renew for another one-year period unless cancelled by you within 30 days prior to the renewal date.
                                  </p>
                                  ...
                                  <p>
                                    ...
                                    Your subscription will automatically renew for another one-year period unless cancelled
                                    by you within 30 days prior to the renewal date.
                                  </p>
                    ...
                    <div class="col-md-12 mt-3 p-3">
                        <div class="mb-3 text-center">
                            <button type="submit"
                                class="btn btn-secondary submit_btn" wire:click="next">Next</button>
                        </div>
                    </div>
