...
@section('content')
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                @if (count($smpa) > 1)
                    <select name="metro_filter" class="form-control mb-3" onchange="filter(event.target.value)">
                        @foreach ($smpa as $item)
                            <option value="{{ $item->cbsa_code }}">{{ $item->cbsa_name }}</option>
                        @endforeach
