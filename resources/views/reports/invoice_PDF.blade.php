...
<body>
    <div class="invoice">
        ...
        <div class="logo w_100 align_left mt_10 mb__10">
            <span class="w_66"></span>
            <img  height="120px" width="230px" src="{{public_path('assets/logo/logo-1.png')}}" alt="Intelli-Rate by BancAnalytics">
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border_none">
                            <img class="margin_0" src="{{public_path('assets/logo/logo-1.png')}}" width="200px" height="80px" alt="Intelli-Rate by BancAnalytics">
